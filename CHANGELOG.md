...
##### v2.0.1 - 2026-08-19
- Исправлено неполное удаление данных расширения из графа при удалении каталога расширения.
- Улучшена скорость поиска инструментов `search_bsl_routines`, `find_form_links`,
  `get_bsl_routine_body`, `get_bsl_modules` и `get_bsl_call_graph`.
- Исправлено зависание индексации кода, если в модулях встречается очень длинная непрерывная строка.
