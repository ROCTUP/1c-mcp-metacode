...
**Основное назначение:** Поиск объектов метаданных по их семантическому содержанию, используя описания, комментарии, синонимы и внутренние имена. Инструмент использует полнотекстовый индекс для поиска по описательным полям.
...
**Особенности:**
- Полнотекстовый поиск по описанию из комментариев к процедуре/функции.
...
**Шаблонные операции:**
- `find_routines_by_description` - полнотекстовый поиск процедур/функций по описанию
...
| **Тип поиска** | Структурный + граф связей | Семантический (fulltext по описаниям) |
...
| **Поиск по описанию процедур** | ❌ Нет | ✅ Да (fulltext по doc_description) |
